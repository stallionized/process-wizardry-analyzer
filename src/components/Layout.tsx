...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        <main className="flex-1 transition-all duration-300 ease-in-out pt-28">
          <div className="p-4">
            <Outlet />
          </div>
        </main>
